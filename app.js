...
let obj = {
  "Juhi":{
    msg:"Happiest Birthday Cutieeee!!! Wishing you a lot of strength to bare me for years to come and lots of happiness in lifee. Love you cutuu ❤️",
...
function displaySlides(n) {
  ...
  if (obj[keys[slide_index]].image.length != 1){
      showSlides(obj[keys[slide_index]].image.length);
      picNo = 1
  }
}
...
function showSlides(n) {
  ...
  picNo += 1;
  setTimeout(function() { showSlides(n); }, 5000); // Change image every 5 seconds
}
